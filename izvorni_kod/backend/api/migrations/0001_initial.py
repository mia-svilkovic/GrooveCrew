# Generated by Django 5.1.4 on 2025-01-16 00:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='records', to='api.location')),
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('record_catalog_number', 'user'), name='unique_record_catalog_number_per_user', violation_error_message="This record catalog number is already added to the user's wishlist.")],
            },
        ),
    ]
